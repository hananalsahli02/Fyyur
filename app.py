...
class Venue(db.Model):
    ...
    def exhaustive_format(self):
        past_shows = Show.past_show_venue(self.id)
        upcoming_shows = Show.upcoming_show_venue(self.id)
...
class Artist(db.Model):
    ...
    def exhaustive_format(self):
        past_shows = Show.past_show_artist(self.id)
        upcoming_shows = Show.upcoming_show_artist(self.id)
...
class Show(db.Model):
    ...
    #Create foreign keys to link relationships between a table artist and a table venue
...
def create_show_submission():
   print('create_show_submission()')
   form = ShowForm()
   try:
      print('try submit show')
      show = Show(
      ...
      db.session.add(show)
      print('about to commit show')
      db.session.commit()
      print('did submit show')
